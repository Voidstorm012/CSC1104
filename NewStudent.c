...
// MONITORING
#define STUDENTID "2101234" // the student ID is not needed in the group project of 2023 (Unused)
...
/*
Handshake algorithm to connect and send blink configurations                // This function is not in used as we are not connecting to oscilloscope
*/
